        ...
        <div className="bg-triangle min-h-screen py-4">
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <div className="bg-white p-1">
              <div className="grid grid-cols-6 gap-1 rounded bg-gray-200 p-1">
                {Object.entries(STUDENTS).map(([id, name]) => (
                  <div
                    key={id}
                    className="flex cursor-pointer flex-col gap-1 rounded-md bg-white p-1 shadow-md"
                  ...
                  >
                    ...
                    <a className="mx-1.5 -skew-x-12 rounded-sm bg-slate-600">
                      <p className="w-full skew-x-12 text-center text-xs leading-5 text-white">
                        {name}
                      </p>
                    </a>
                  </div>
